...
def parse_args(base_parser, args, namespace):
    ...
    parser.add_argument('--pe', default='learnable', choices=['learnable', 'rope', 'random', 'mixed'])
    ...
    parser.add_argument('--max_context_ratio', default=1, type=int)
    parser.add_argument('--long_context', action='store_true')
    parser.add_argument('--random_pe', action='store_true')
